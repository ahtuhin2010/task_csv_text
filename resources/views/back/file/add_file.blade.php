...
<div class="container-fluid">
    <div class="card tab2-card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('file.store') }}" id="myForm" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                        ...
                        <div class="form-group row">
                            <label for="validationCustom0" class="col-xl-3 col-md-3"><span style="color:red">*</span> File</label>
                            <input id="csv" class="form-control col-xl-8 col-md-8" id="validationCustom0" type="file" name="csv" value="{{ old('password') }}">
                            <font class="ml-1" style="color: red">{{ ($errors->has('csv'))?($errors->first('csv')):'' }}</font>
                        </div>
                    </div>

<div class="page-main-header">
    <div class="main-header-left">
        <div class="logo-wrapper"><a href="{{ route('dashboard') }}"><img class="blur-up lazyloaded" src="{{ asset('backend/images/layout-2/logo/logo.png')}}" alt=""></a></div>
    </div>
        ...
        <div class="nav-right col">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="{{ asset('backend/images/dashboard/man.png') }}" alt="header-user">
                    ...
                    <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                        ...
                        <li>
                            ...
                            <span class="pull-right"><i data-feather="settings"></i></span></a>
                        </li>
